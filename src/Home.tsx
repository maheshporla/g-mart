...
function Home({ setPage }: HomeProps) {
  return (
    <div className="max-w-7xl mx-auto bg-gradient-to-br from-white via-green-50 to-lime-50 rounded-[40px] shadow-xl overflow-hidden">

      <div className="grid lg:grid-cols-2 gap-12 items-center px-8 lg:px-16 py-16">
        ...
        {/* Right Image */}
       <div className="flex justify-center items-start -mt-100">
